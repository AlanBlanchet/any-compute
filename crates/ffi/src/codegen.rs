...
mod tests {
    ...
    fn generate_all_writes_files() {
        ...
        assert!(tmp.join("python/any_compute.py").exists());
        assert!(tmp.join("python/test_any_compute.py").exists());
        assert!(tmp.join("javascript/any_compute.js").exists());
        assert!(tmp.join("javascript/any_compute.d.ts").exists());
        assert!(tmp.join("javascript/any_compute.test.js").exists());
        assert!(tmp.join("java/com/anycompute/AnyCompute.java").exists());
        assert!(tmp.join("java/com/anycompute/AnyComputeTest.java").exists());
